...
| OpenAI | gpt-5.4 family (gpt-5.4, gpt-5.4-mini) and gpt-5.6 family | gpt-5.6-luna |
...
- Cost-aware model selection: cheap models (Haiku, gpt-5.6-luna) for simple tasks, expensive models (Opus) only when reasoning quality matters
