...
- Flag as **BLOCKING** any new hardcoded model strings the diff introduces — e.g., literal `"gpt-5.4-mini"`, `"claude-sonnet-5"`, `"claude-haiku-4-5"`, or deprecated names like `"gpt-4o"`, `"o3"`, `"claude-3-*"`.
